<!DOCTYPE html>
<!-- saved from url=(0077)https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html -->
<html lang="en" style="transform: none;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<!-- Favicon -->
		<link rel="icon" type="image/x-icon" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/assets/img/favicon.png">
		
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="./employment_files/bootstrap.min.css">
		
		<!-- Linearicon Font -->
		<link rel="stylesheet" href="./employment_files/lnr-icon.css">
				
		<!-- Fontawesome CSS -->
        <link rel="stylesheet" href="./employment_files/font-awesome.min.css">
		
		<!-- Select2 CSS -->
		<link rel="stylesheet" href="./employment_files/select2.min.css">
				
		<!-- Custom CSS -->
		<link rel="stylesheet" href="./employment_files/style.css">
	...
	<body style="transform: none; overflow: visible;">
						...
						<div class="row align-items-center">
							<div class="col-lg-3 col-md-3 col-sm-3 col-6">
								<div class="logo my-3 my-sm-0">
									<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/index.html">
									<img src="./employment_files/logo.png" alt="logo image" class="img-fluid" width="100">
									</a>
								</div>
							</div>
											...
											<div class="user-notification-block align-right d-inline-block">
												<ul class="list-inline m-0">
													<li class="list-inline-item item-animated" data-toggle="tooltip" data-placement="top" title="" data-original-title="Apply Leave">
														<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/leave.html" class="font-23 menu-style text-white align-middle">
											...
											<div class="user-info align-right dropdown d-inline-block header-dropdown">
												<a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
													<div class="user-avatar d-inline-block">
														<img src="./employment_files/img-6.jpg" alt="user avatar" class="rounded-circle img-fluid" width="55">
													</div>
												</a>
												
												<!-- Notifications -->
												<div class="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
													<a class="dropdown-item p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html">
													...
													<a class="dropdown-item p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/profile-settings.html">
														<span class="media align-items-center">
													...
													<a class="dropdown-item p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/login.html">
														<span class="media align-items-center">
								...
								<div class="d-block d-lg-none">
									...
									<!-- Offcanvas menu -->
										...
										<div class="user-info align-center bg-theme text-center">
											<a href="javascript:void(0)" class="d-block menu-style text-white">
												<div class="user-avatar d-inline-block mr-3">
													<img src="./employment_files/img-6.jpg" alt="user avatar" class="rounded-circle" width="50">
												</div>
											</a>
										</div>
										...
										<div class="user-menu-items px-3 m-0">
											<a class="px-0 pb-2 pt-0" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/index.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employees.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/company.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/calendar.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/leave.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/reviews.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/reports.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/manage.html">
												<span class="media align-items-center">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/settings.html">
												<span class="media align-items-center">
													<span class="lnr lnr-cog mr-3"></span>
													<span class="media-body text-truncate text-left">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html">
												<span class="media align-items-center">
													<span class="lnr lnr-user mr-3"></span>
													<span class="media-body text-truncate text-left">
											...
											<a class="p-2" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/login.html">
												<span class="media align-items-center">
													<span class="lnr lnr-power-switch mr-3"></span>
													<span class="media-body text-truncate text-left">
								...
								<div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
									<div class="append mr-auto my-0 my-md-0 mr-auto">
										<ul class="list-group list-group-horizontal-md mr-auto">
											<li class="mr-1"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/index.html" class="text-dark btn-ctm-space"><span class="lnr lnr-home pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Dashboard</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employees.html"><span class="lnr lnr-users pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Employees</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/company.html"><span class="lnr lnr-apartment pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Company</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/calendar.html"><span class="lnr lnr-calendar-full pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Calendar</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/leave.html"><span class="lnr lnr-briefcase pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Leave</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/reviews.html"><span class="lnr lnr-star pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Reviews</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/reports.html"><span class="lnr lnr-rocket pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Reports</span></a></li>
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/manage.html"><span class="lnr lnr-sync pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Manage</span></a></li>
											<li class="mr-1 active"><a class="text-white btn-ctm-space" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/settings.html"><span class="lnr lnr-cog pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Settings</span></a></li>
										</ul>
									</div>
					...
					<div class="row" style="transform: none;">
						...
						<div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none;"><aside class="sidebar sidebar-user">
												...
												<div class="custom-search input-group">
													<div class="custom-breadcrumb">
														<ol class="breadcrumb no-bg-color d-inline-block p-0 m-0 mb-2">
															<li class="breadcrumb-item d-inline-block"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/index.html" class="text-dark">Home</a></li>
								...
								<div class="user-card shadow-sm bg-white p-4 text-center ctm-border-radius card">
									<div class="user-info">
										<div class="user-avatar mb-4">
											<img src="./employment_files/img-6.jpg" alt="User Avatar" class="img-fluid rounded-circle" width="100">
										</div>
								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white p-4 mb-4 card">
									<ul class="list-group">
										<li class="list-group-item text-center active button-5"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html" class="text-white">Employement</a></li>
										<li class="list-group-item text-center button-6"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/details.html" class="text-dark">Detail</a></li>
										<li class="list-group-item text-center button-6"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/documents.html" class="text-dark">Document</a></li>
										<li class="list-group-item text-center button-6"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/payroll.html" class="text-dark">Payroll</a></li>
										<li class="list-group-item text-center button-6"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/time-off.html" class="text-dark">Timeoff</a></li>
										<li class="list-group-item text-center button-6"><a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/profile-reviews.html" class="text-dark">Reviews</a></li>
										<li class="list-group-item text-center button-6"><a class="text-dark" href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/profile-settings.html">Settings</a></li>
									</ul>
								</div>
							</aside><div class="resize-sensor" style="position: absolute; inset: 0px; overflow: hidden; z-index: -1; visibility: hidden;"><div class="resize-sensor-expand" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;"><div style="position: absolute; left: 0px; top: 0px; transition: all 0s ease 0s; width: 319px; height: 1060px;"></div></div><div class="resize-sensor-shrink" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;"><div style="position: absolute; left: 0; top: 0; transition: 0s; width: 200%; height: 200%"></div></div></div></div></div>
									...
									<div class="card add-team flex-fill ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											<div class="form-group mb-3">
												...
												</select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-yjsr-container"><span class="select2-selection__rendered" id="select2-yjsr-container" title="Select Team">Select Team</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
											</div>
									...
									<div class="card office-card flex-fill ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											<p class="d-inline-block mb-0">
												<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html" class="avatar d-inline-block"><img src="./employment_files/img-6.jpg" alt="Maria Cotton" class="img-fluid"></a>
												<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html" class="d-inline-block ml-4 text-primary">Maria Cotton</a>
											</p>
										</div>
									</div>
								</div>
								...
								<div class="col-12">
									<div class="card ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											...
											<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Danny Ward"><img alt="avatar image" src="./employment_files/img-5.jpg" class="img-fluid"></span></a>
											<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Linda Craver"><img class="img-fluid" alt="avatar image" src="./employment_files/img-4.jpg"></span></a>
											<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jenni Sims"><img class="img-fluid" alt="avatar image" src="./employment_files/img-3.jpg"></span></a>
											<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Maria Cotton"><img alt="avatar image" src="./employment_files/img-6.jpg" class="img-fluid"></span></a>
											<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="John Gibbs"><img class="img-fluid" alt="avatar image" src="./employment_files/img-2.jpg"></span></a>
											<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Richard Wilson"><img class="img-fluid" alt="avatar image" src="./employment_files/img-10.jpg"></span></a>
									...
									<div class="card flex-fill ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											<div class="media mb-4">
												<img class="rounded mr-3 img-fluid" src="./employment_files/img-10.jpg" alt="avatar image" width="50" height="50">
												<div class="media-body">
													<a href="https://dleohr.dreamguystech.com/template-1/dleohr-horizontal/employment.html" class="text-dark text-ellipsis">Richard Wilson</a>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<select class="form-control select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
								...
								<option value="5">Business</option>
								<option value="6">Accounts</option>
							</select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-mbiw-container"><span class="select2-selection__rendered" id="select2-mbiw-container" title="PHP">PHP</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
						</div>
						<button type="button" class="btn btn-danger text-white ctm-border-radius float-right ml-3" data-dismiss="modal">Cancel</button>
						<button type="button" class="btn btn-theme button-1 text-white ctm-border-radius float-right">Add</button>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							</select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-fsnd-container"><span class="select2-selection__rendered" id="select2-fsnd-container" title="Select">Select</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
						</div>
						<button type="button" class="btn btn-danger text-white ctm-border-radius float-right ml-3" data-dismiss="modal">Cancel</button>
						<button type="button" class="btn btn-theme button-1 text-white ctm-border-radius float-right">Add</button>
					</div>
		...
		<!-- jQuery -->
		<script src="./employment_files/jquery-3.2.1.min.js.download"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="./employment_files/popper.min.js.download"></script>
		<script src="./employment_files/bootstrap.min.js.download"></script>
		
		<!-- Sticky sidebar JS -->
		<script src="./employment_files/ResizeSensor.js.download"></script>		
		<script src="./employment_files/theia-sticky-sidebar.js.download"></script>		
		
		<!-- Select2 JS -->
		<script src="./employment_files/select2.min.js.download"></script>		
		
		<!-- Custom Js -->
		<script src="./employment_files/script.js.download"></script>
